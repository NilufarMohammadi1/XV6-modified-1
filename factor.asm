...
int main(int argc, char *argv[])
{
  ...
  exit();
  24:	e8 79 03 00 00       	call   3a2 <exit>
  29:	66 90                	xchg   %ax,%ax
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
...
void factor(int num){
  ...
  3e:	68 48 08 00 00       	push   $0x848
  43:	e8 9a 03 00 00       	call   3e2 <open>
    if(fd != -1)
  48:	83 c4 10             	add    $0x10,%esp
  4b:	83 f8 ff             	cmp    $0xffffffff,%eax
    int fd = open("factor_result.txt", O_CREATE | O_RDWR);
  4e:	89 45 d0             	mov    %eax,-0x30(%ebp)
    if(fd != -1)
  51:	74 24                	je     77 <factor+0x47>
        unlink("factor_result.txt");
  53:	83 ec 0c             	sub    $0xc,%esp
  56:	68 48 08 00 00       	push   $0x848
  5b:	e8 92 03 00 00       	call   3f2 <unlink>
        fd = open("factor_result.txt", O_CREATE | O_RDWR);
  60:	5a                   	pop    %edx
  61:	59                   	pop    %ecx
  62:	68 02 02 00 00       	push   $0x202
  67:	68 48 08 00 00       	push   $0x848
  6c:	e8 71 03 00 00       	call   3e2 <open>
  71:	83 c4 10             	add    $0x10,%esp
  74:	89 45 d0             	mov    %eax,-0x30(%ebp)
    for(int i = 1; i <= num; i++)
  77:	8b 45 08             	mov    0x8(%ebp),%eax
  7a:	85 c0                	test   %eax,%eax
  7c:	7e 28                	jle    a6 <factor+0x76>
  7e:	8b 45 08             	mov    0x8(%ebp),%eax
  81:	bf 01 00 00 00       	mov    $0x1,%edi
  86:	83 c0 01             	add    $0x1,%eax
  89:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(num % i == 0)
  90:	8b 45 08             	mov    0x8(%ebp),%eax
  93:	89 f9                	mov    %edi,%ecx
  95:	99                   	cltd   
  96:	f7 ff                	idiv   %edi
  98:	85 d2                	test   %edx,%edx
  9a:	89 d3                	mov    %edx,%ebx
  9c:	74 34                	je     d2 <factor+0xa2>
    for(int i = 1; i <= num; i++)
  9e:	83 c7 01             	add    $0x1,%edi
  a1:	3b 7d d4             	cmp    -0x2c(%ebp),%edi
  a4:	75 ea                	jne    90 <factor+0x60>
    write(fd, "\n", sizeof(char));
  a6:	8b 75 d0             	mov    -0x30(%ebp),%esi
  a9:	83 ec 04             	sub    $0x4,%esp
  ac:	6a 01                	push   $0x1
  ae:	68 5c 08 00 00       	push   $0x85c
  b3:	56                   	push   %esi
  b4:	e8 09 03 00 00       	call   3c2 <write>
    close(fd);
  b9:	89 34 24             	mov    %esi,(%esp)
  bc:	e8 09 03 00 00       	call   3ca <close>
}
  c1:	83 c4 10             	add    $0x10,%esp
  c4:	8d 65 f4             	lea    -0xc(%ebp),%esp
  c7:	5b                   	pop    %ebx
  c8:	5e                   	pop    %esi
  c9:	5f                   	pop    %edi
  ca:	5d                   	pop    %ebp
  ...
  d2:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
  d7:	8d 73 01             	lea    0x1(%ebx),%esi
  da:	f7 e1                	mul    %ecx
  dc:	c1 ea 03             	shr    $0x3,%edx
  df:	8d 04 92             	lea    (%edx,%edx,4),%eax
  e2:	01 c0                	add    %eax,%eax
  e4:	29 c1                	sub    %eax,%ecx
  e6:	83 c1 30             	add    $0x30,%ecx
            while(divisor != 0)
  e9:	85 d2                	test   %edx,%edx
                buf[j++] = '0' + divisor % 10;
  eb:	88 4c 35 d7          	mov    %cl,-0x29(%ebp,%esi,1)
                divisor /= 10;
  ef:	89 d1                	mov    %edx,%ecx
            while(divisor != 0)
  f1:	75 dd                	jne    d0 <factor+0xa0>
  f3:	8d 45 d8             	lea    -0x28(%ebp),%eax
  f6:	89 7d cc             	mov    %edi,-0x34(%ebp)
  f9:	8d 75 d6             	lea    -0x2a(%ebp),%esi
  fc:	01 c3                	add    %eax,%ebx
  fe:	89 df                	mov    %ebx,%edi
 100:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 103:	90                   	nop
 ...
 10b:	6a 01                	push   $0x1
 10d:	57                   	push   %edi
 10e:	83 ef 01             	sub    $0x1,%edi
 111:	53                   	push   %ebx
 112:	e8 ab 02 00 00       	call   3c2 <write>
            while (j-- >= 0)
 117:	83 c4 10             	add    $0x10,%esp
 11a:	39 fe                	cmp    %edi,%esi
 11c:	75 ea                	jne    108 <factor+0xd8>
            write(fd, " ", sizeof(char));
 11e:	83 ec 04             	sub    $0x4,%esp
 121:	8b 7d cc             	mov    -0x34(%ebp),%edi
 124:	6a 01                	push   $0x1
 126:	68 5a 08 00 00       	push   $0x85a
 12b:	ff 75 d0             	pushl  -0x30(%ebp)
    for(int i = 1; i <= num; i++)
 12e:	83 c7 01             	add    $0x1,%edi
            write(fd, " ", sizeof(char));
 131:	e8 8c 02 00 00       	call   3c2 <write>
 136:	83 c4 10             	add    $0x10,%esp
    for(int i = 1; i <= num; i++)
 139:	3b 7d d4             	cmp    -0x2c(%ebp),%edi
 13c:	0f 85 4e ff ff ff    	jne    90 <factor+0x60>
 142:	e9 5f ff ff ff       	jmp    a6 <factor+0x76>
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 5e 08 00 00       	mov    $0x85e,%ebx
        while(*s != 0){
 ...
 6c1:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 3c 0b 00 00    	cmp    %eax,0xb3c
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 817:	0b 00 00 
 81a:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 821:	0b 00 00 
    base.s.size = 0;
 824:	b8 40 0b 00 00       	mov    $0xb40,%eax
 829:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 830:	00 00 00 
