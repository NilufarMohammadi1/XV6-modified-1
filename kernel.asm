...
8010085e:	83 e8 01             	sub    $0x1,%eax
        input.size--;
80100861:	83 2d ac ff 10 80 01 	subl   $0x1,0x8010ffac
        input.e--;
80100868:	a3 a8 ff 10 80       	mov    %eax,0x8010ffa8
        consputc(BACKSPACE);
8010086d:	b8 00 01 00 00       	mov    $0x100,%eax
80100872:	e8 99 fb ff ff       	call   80100410 <consputc>
  while((c = getc()) >= 0){
80100877:	ff d3                	call   *%ebx
80100879:	85 c0                	test   %eax,%eax
8010087b:	89 c7                	mov    %eax,%edi
8010087d:	79 b9                	jns    80100838 <consoleintr+0x28>
8010087f:	90                   	nop
  release(&cons.lock);
...
80100943:	75 32                	jne    80100977 <consoleintr+0x167>
...
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
        input.size--;
8010095a:	83 2d ac ff 10 80 01 	subl   $0x1,0x8010ffac
        consputc(BACKSPACE);
80100961:	e8 aa fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
80100966:	a1 a8 ff 10 80       	mov    0x8010ffa8,%eax
8010096b:	3b 05 a4 ff 10 80    	cmp    0x8010ffa4,%eax
80100971:	0f 84 b9 fe ff ff    	je     80100830 <consoleintr+0x20>
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
80100977:	83 e8 01             	sub    $0x1,%eax
8010097a:	89 c2                	mov    %eax,%edx
8010097c:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
8010097f:	80 ba 20 ff 10 80 0a 	cmpb   $0xa,-0x7fef00e0(%edx)
80100986:	75 c8                	jne    80100950 <consoleintr+0x140>
80100988:	e9 a3 fe ff ff       	jmp    80100830 <consoleintr+0x20>
