...
main(void)
{
  ...
  60:	e8 4b 04 00 00       	call   4b0 <printf>
    printf(1, "1. Nilufar Mohammadi hastam\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  ...
  6e:	e8 3d 04 00 00       	call   4b0 <printf>
    ...
    pid = fork();
  73:	e8 e2 02 00 00       	call   35a <fork>
    if(pid < 0){
  ...
  b0:	6a 01                	push   $0x1
  b2:	e8 f9 03 00 00       	call   4b0 <printf>
      exit();
  b7:	e8 a6 02 00 00       	call   362 <exit>
      exec("sh", argv);
  bc:	50                   	push   %eax
  bd:	50                   	push   %eax
  be:	68 2c 0b 00 00       	push   $0xb2c
  c3:	68 5b 08 00 00       	push   $0x85b
  c8:	e8 cd 02 00 00       	call   39a <exec>
      printf(1, "init: exec sh failed\n");
  cd:	5a                   	pop    %edx
  ce:	59                   	pop    %ecx
  cf:	68 5e 08 00 00       	push   $0x85e
  d4:	6a 01                	push   $0x1
  d6:	e8 d5 03 00 00       	call   4b0 <printf>
      exit();
  db:	e8 82 02 00 00       	call   362 <exit>
    mknod("console", 1, 1);
  e0:	50                   	push   %eax
  e1:	6a 01                	push   $0x1
  e3:	6a 01                	push   $0x1
  e5:	68 08 08 00 00       	push   $0x808
  ea:	e8 bb 02 00 00       	call   3aa <mknod>
    open("console", O_RDWR);
  ef:	58                   	pop    %eax
  f0:	5a                   	pop    %edx
  f1:	6a 02                	push   $0x2
  f3:	68 08 08 00 00       	push   $0x808
  f8:	e8 a5 02 00 00       	call   3a2 <open>
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 7d 08 00 00       	mov    $0x87d,%ebx
        while(*s != 0){
